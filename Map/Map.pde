...
void draw() {
  if (startscreen) {
    ...
    text("- In the case of carrier units, a unit may be moved onto another unit. When this is done the moving unit will disappear and the carrier unit will be marked with an", 20, 140);
    text("'L' to indicate that it is loaded.", 20, 160);
    text("- To unload the unit, simply press 'u' on a square next to a loaded unit and the unit will reappear there and the 'L' will be removed.", 20, 180);
    text("- If a building is selected, if the building is an airport, base, or seaport, the player's mouse can be used to select units to build from the menu on the right side", 20, 200);
    text("of the screen.", 20, 220);
    text("- Moving the cursor away will take the menu away, and using 'x' again will deselect the building.", 20, 240);
    text("- To capture a building, move an infantry or mech unit over a building. Keeping it there without moving for two turns will capture the building.", 20, 260);
    text("- After a turn has been completed, press 'ENTER' to begin the next person's turn.", 20, 280);
        fill(255, 255, 255);
    rect(20, 600, 100, 25);
    fill(0);
    textFont(f, 16);
