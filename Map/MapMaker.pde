class MapMaker {
  ...
  void swanCave(){
     ...
     tGen("p p brp p o4odl8l8l8l8l8l8l8l8l9f f f f p f p or", 4, len);
     tGen("p p sro4odo2o o o o o o o o o o3l8l9snp p bno4o2", 5, len);
     tGen("odododo2o o o o o0l2l2l2l2o1o o o o3ododo5rvoro ", 6, len);
     tGen("o o o o o o o o olsncnf cnl1o1o o o o o olrvoro ", 7, len);
     ...
     tGen("ououououo1o o o o o o o o o o o0l2l3snp p f p or", 11, len);
     tGen("p p sbp o7ouo1o0l2l2l2l2o1o0l2l3f p p cbcbp f or", 12, len);
     tGen("p bbbbbbp p o7o6p f f f l1l3f f f f f p p p o4o2", 13, len);
  ...
  void royalChannel(){
   ...
   tGen("m p p p cnr0cnrhcnrhrhcnp p r0rhrhrhrhrhr1cnoro o o o o o olsraroro o o o o o ", 2, len);
   tGen("p p cncnrhrcr1p p p p rcrhcnr2p p p p p rvo4o2o o o o o o o3ododo2o o o o o o ", 3, len);
   ...
   tGen("rvp f p f f p f f f crp crcrf p p f o4o2o o o olp oro o o o o o o o o o0l2l2l2", 8, len);
   tGen("r3cnp p p f cnp p f f f f f p p f f oro o o o olsroro o o o o o o o o0l3p p p ", 9, len);
   tGen("f f f f p p p f p p f f f p p f f o4o2o o o o o3odo2o o o o o o o0l2olp p f p ", 10, len);
   tGen("f f p f f p f f f crf f p p f f f oro o o o o o o o o o o o o0l2olp o7sbabp p ", 11, len);
   tGen("f p p p p p p f f p f p p f f f o4o2o o o o o o o o o o o0l2l3f o7sbrhbbrhabp ", 12, len);
   tGen("f p f f f f p p f p p p f f f o4o2o o o o o o o o o o0l2l3p p m p r3bbhbbbr2p ", 13, len);
   tGen("f p p f f f f p p p f f f f o4o2o o0ouo1o o o o o o0l3p p p m p p p r3bbr2p p ", 14, len);
   tGen("f f p f f f f f p f f f f o4o2o o olp oro o o o o0l3p p p m p p p bbp rvp abp ", 15, len);
   tGen("f f p p f f f f p f f f o4o2o o o olsroro o o o0l3p p p f p p cbcbr0rhrccbp p ", 16, len);
   tGen("f f f p f f f p p f f o4o2o o o o o3odo2o o o0l3p p p p p r0rhrhrhr2p rvp f p ", 17, len);
   tGen("f p p p p p p p f f o4o2o o o o o o o o o o0l3p p p f cbcbrvp p p p cbrvp p f ", 18, len);
   tGen("p arrhbrrhbrr1p p l7o2o o o o o o o o o o0l3p p p f f rhrhrccbcbp m p r3r1p p ", 19, len);
   tGen("rvp brhrbrp r3rhl7o2o o o o o o o o o o0l3p p m p f p p p rvp p m m m p rvcbp ", 20, len);
   tGen("rvarp brrhsrl7l8o2o o o o o o o o o o l6p p m p p p p p m rvp m m m m p rvp p ", 21, len);
   tGen("r3rcsrr2l7odo2o o o o o o o o o o o0l2l3p m m p cncncnp p rvp p p m p p rvcbp ", 22, len);
   tGen("p rvo4l8o2o o o o o o o o o o o o0l3p p m m p p r0rhrhrhrhrccncncnp p cnrvp p ", 23, len);
   tGen("l8l8o2o o o o o o o o o o o o o olp m m p p p cnrvp p p p r3rhrhrhrhanrhrccnp ", 24, len);
   tGen("o o o o o o o o o o o o o o o o0ousnp p anr0rhrhr2p m p cnp p p p m p p rvp p ", 25, len);
   tGen("o o o o o o o o o o o o o o o l6p r3cnp p rvp p p m p p p p f f f m p cnrvp m ", 26, len);
   tGen("o o o o o o o o o o o o o o o0l3p p rvp p rvp f p p cncnp p p p p p p p rvp m ", 27, len);
   tGen("o o o o o o o o o o o o o o l6p p cnr3cncnr3rhrhrhrhrhrhrhrhrhcncncncnrhr2p m ", 28, len);
   tGen("o o o o o o o o o o o o o o l6p p p p p p p p p p p p p p p p p p p p p p p m ", 29, len);
 }
  ...
  void tGen(String terr, int row, int len) {
    for (int i = 0; i < len; i++) {
      ...
      if (s.substring(0, 1).equals("r")) {
        ...
        if (s.substring(1, 2).equals("c")) _board[row][i].terrain = new Ocean(i, row, 16);
        ...
        if (s.substring(1, 2).equals("7")) _board[row][i].terrain = new Shoal(i, row, 0);
        if (s.substring(1, 2).equals("8")) _board[row][i].terrain = new Shoal(i, row, 1);
        if (s.substring(1, 2).equals("9")) _board[row][i].terrain = new Shoal(i, row, 2);
        if (s.substring(1, 2).equals("6")) _board[row][i].terrain = new Shoal(i, row, 3);
        if (s.substring(1, 2).equals("3")) _board[row][i].terrain = new Shoal(i, row, 4);
        if (s.substring(1, 2).equals("2")) _board[row][i].terrain = new Shoal(i, row, 5);
        if (s.substring(1, 2).equals("1")) _board[row][i].terrain = new Shoal(i, row, 6);
        if (s.substring(1, 2).equals("4")) _board[row][i].terrain = new Shoal(i, row, 7);
      } else {
        int x = i;
